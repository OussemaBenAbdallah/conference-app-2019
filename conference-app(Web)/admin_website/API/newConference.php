...
$conference->short_name_conf = $_GET['short_name_conf'];
$conference->email_conf = $_GET['email_conf'];
$conference->website = $_GET['website'];
...
if ($conference->exist()){
    Header("Location: ./updateConference.php?".$_SERVER['QUERY_STRING']);
}
